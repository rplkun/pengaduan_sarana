...
if(isset($_POST['simpan'])){
   $st=$_POST['status'];$fb=$_POST['feedback'];
   mysqli_query($conn, "UPDATE aspirasi SET status='$st',feedback'$fb' WHERE id_aspirasi='$id'");
   header("location:dashboard.php");
}
$q=mysqli_query($conn, "SELECT i.*,a.feedback FROM input_aspirasi i LEFT JOIN aspirasi a ON i.id_pelaporan=a.id_aspirasi WHERE i.id_pelaporan='$id'");
...
<html>
    ...
    <body class="bg-light">
        <div class="container mt-5">
            <div class="card max-auto shadow-sm-p4" style="max-width: 500px;">
                ...
                <form method="POST">
                    <div class="mb-3">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="feedback"class="from-control">value="<?= $d['feedback'] ?>"<required>
                        </div>
